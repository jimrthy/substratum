...
;; Antonio Andrade's Datomic Data Platform.
;; Refactored from frereth-server
;; This is really the heart/point of the entire library.
;; It really needs to be moved into a .clj file so it gets distributed
;; and can be read by things that use substratum.
;; I also need to set up platform.clj so its only purpose in life
;; is to install this.
;; Well, and maybe whichever entity types that the real end-users need.
